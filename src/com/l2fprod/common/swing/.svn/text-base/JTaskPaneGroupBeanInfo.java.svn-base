...
public class JTaskPaneGroupBeanInfo extends SimpleBeanInfo
{
   ...
   public PropertyDescriptor[] getPropertyDescriptors() 
   {
      try
      {
         ...
         try
         {
            descriptor = new PropertyDescriptor("text", com.l2fprod.common.swing.JTaskPaneGroup.class);
         }
         catch (IntrospectionException e)
         {
            descriptor = new PropertyDescriptor("text", com.l2fprod.common.swing.JTaskPaneGroup.class, "getText", null);
         }
